...
export default function AboutPage() {
  return (
    <section className="p-10 relative flex flex-col lg:flex-row items-start gap-10">
      <div className="flex-1">
        ...
        >
          Hi, I’m{" "}
          <span className="font-semibold text-[#E5D8C2]">Jordan Arrivado</span>,
          a recent graduate and aspiring <strong>Web/Software Developer</strong>{" "}
